...
public class User_Oper {
    ...
    public void click_yhgl(WebDriver driver) throws InterruptedException {
        //用户管理
        // 获取所有<div>元素 div[data-v-268e2540] .title 中间一定要有空格
        //进入用户管理
        System.out.println("进入用户管理");
        String a_system="li.el-menu-item > span";
        c_index_ele=c_oper.get_Element_index(driver,a_system,"用户管理","css");
